...
% -------------------------------------------------------------------------
\node[layerlabel,text=phase1blue!80!black] at (5.8,7.10) {Research context};
\node[layerlabel,text=phase2green!60!black] at (6.6,5.05) {Control and validation layer};
\node[layerlabel,text=phase3orange!75!black] at (7.0,3.15) {Execution layer: clinical and quantum paths};
\node[layerlabel,text=phase4purple!75!black] at (6.2,1.0) {Policy, allocation, mediation, and fairness--performance synthesis};
\node[layerlabel,text=phase4purple!75!black] at (5.7,-1.10) {Artifacts layer};
\node[layerlabel,text=red!70!black] at (8.25,-2.55) {Next-semester extension points};
