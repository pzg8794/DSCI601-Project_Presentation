...
\end{itemize}
\alert{A policy can look accurate on average while delaying care for a vulnerable group.}
\end{column}
\begin{column}{0.48\textwidth}
...
\end{itemize}
\alert{A policy can maximize throughput while some flows receive worse service.}
\end{column}
\end{columns}
\end{frame}
